...
models = {
    "Mediar + Paper Weights": {
        "path": "/work/scratch/geiger/Datasets/CTC/Fluo-N3DL-TRIC/02_test_final_res/paper/summary_boxplot/summary_seg_boxplot_iou_mean.csv",
        "threshold": 0.01,
    },
    "Mediar + SAM2 Encoder": {
        "path":  "/work/scratch/geiger/Datasets/CTC/Fluo-N3DL-TRIC/02_test_final_res/hiera/summary_boxplot/summary_seg_boxplot_iou_mean_hiera.csv",
        "threshold": 0.1,
    },
    "Mediar + Extended Pretraining": {
        "path": "/work/scratch/geiger/Datasets/CTC/Fluo-N3DL-TRIC/02_test_final_res/condor/summary_boxplot/summary_seg_boxplot_iou_mean_Tric_condor.csv",
        "threshold": 0.4,
    }
}
