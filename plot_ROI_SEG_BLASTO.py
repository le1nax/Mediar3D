...
models = {
    "Mediar + Paper Weights": {
        "path": "/work/scratch/geiger/Datasets/Blasto/final_test/final_results/paper/summary/summary_seg_boxplot_iou_mean_paper1.csv",
        "threshold": 0.0001,
    },
    "Mediar + SAM2 Encoder": {
        "path":  "/work/scratch/geiger/Datasets/Blasto/final_test/final_results/hiera/summary_boxplot/summary_seg_boxplot_iou_mean.csv",
        "threshold": 0.01,
    },
    "Mediar + Extended Pretraining": {
        "path": "/work/scratch/geiger/Datasets/Blasto/final_test/final_results/condor/summary_boxplots/summary_seg_boxplot_iou_mean.csv",
        "threshold": 0.005,
    },
    "CellposeSAM": {
        "path": "/work/scratch/geiger/Datasets/Blasto/final_test/final_results/cpsam_thresholds/summary_boxplot/summary_seg_boxplot_iou_mean_modified_exponential.csv",
        "threshold": 0.0,
    },
}
